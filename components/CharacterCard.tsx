...
import ProfessionTooltip from "./ProfessionTooltip";
...
export default function CharacterCard({ character }: CharacterCardProps) {
  ...
  return (
    <div className="flex overflow-visible rounded-lg border border-gray-700 bg-gray-900 hover:-translate-y-1 transition-colors hover:bg-gray-800 group relative">
      ...
      <div className="flex-1 p-4">
        ...
        <div className="mt-3 flex gap-2">
            {character.professions.map((characterProfession) => (
                <ProfessionTooltip
                    key={characterProfession.profession}
